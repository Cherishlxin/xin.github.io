...
## 💼 工作经历
  - 基于接近信道容量的前向纠错码在连续变量量子密钥分发中的应用研究，2021.02 至今，国家留学基金委基金项目(CSC: 202006160015)
  ...
  - 基于多载波OFDM/OTFS 量子传输的连续变量量子秘钥分发系统研究，2021.02 ，至今国家留学基金委基金项目(CSC: 202006160015)
...
- *Publishcation*
  - [1] **X. Liu**, C. Xu, S. X. Ng and L. Hanzo, “Analog Beamforming Assisted OTFS-Based CV-QKD Systems for Doubly Selective THz Estimated Channels,” *IEEE Transactions on Vehicular Technology*, under review. IF=6.1.
  - [2] **X. Liu**, C. Xu, S. Wang, S. X. Ng and L. Hanzo, “Hybrid Beamforming Assisted OTFS-Based CV-QKD Systems for Doubly Selective THz Channels,” *IEEE Transactions on Communications*, under review. IF=7.2.
  - [3] D. Wang, **X. Liu**, C. Xu, S. X. Ng and L. Hanzo, “Short Polar Codes are capable of Outperforming LDPC Codes in CV-QKD,” *IEEE Open Journal of Vehicular Technology*, under review. IF=5.3.
  - [4] **X. Liu**, C. Xu, S. X. Ng and L. Hanzo, “OTFS-Based CV-QKD Systems for Doubly Selective THz Channels,” *IEEE Transactions on Communications*, accepted, 2025. IF=7.2
...
5, pp. 2089-2112, 2024. IF=6.3
  - [6] **X. Liu**, R. Li, K. Luo, and T. Jiang, “Downlink and Uplink Decoupling in Heterogeneous Networks
for 5G and Beyond,” *Journal of Communications and Information Networks*, vol. 3, no. 2,
pp. 1-13, 2018. IF=3.6
  - [7] R. Li, **X. Liu**, K. Luo, T. Jiang, and S. Jin, “Decoupled Access in HetNets with Backhaul
...
- 自我评价
  - 为人本分踏实，责任心强；热衷于无线通信及计算机技术的研究，具备较强的学习能力，能够快速掌握
并理解新知识，并高效完成各项任务；做事稳重踏实，认真负责；善于沟通与团队合作，具有较强的社
会适应能力。
...
- **Side-by-Side Preview**:  
  ...
  *(Or click the "Open Preview" icon in the top-right of the editor.)*

- **Live Preview (Split Screen)**:  
  Right-click the file → **Open Preview to the Side**.

---

### **6. Customize Markdown Settings**
1. Go to `File > Preferences > Settings` (`Ctrl + ,` or `Cmd + ,`).
2. Search for "Markdown" to adjust:
   - **Auto-scrolling** (sync preview with editor).
   - **Syntax highlighting** themes.
   - **Extensions-specific options** (e.g., table formatting).

---

### **7. Export Markdown (Optional)**
- Use **Markdown Preview Enhanced** to export to:
  - PDF (`Right-click preview → Export to PDF`).
  - HTML (`Ctrl + K → V` to open in browser, then save as HTML).
...
### **Troubleshooting**
- **Preview not working?** Ensure the file is saved with `.md` extension.
- **Extensions not loading?** Restart VS Code after installation.

VS Code turns Markdown into a powerhouse with these tools! Try it out and tweak as needed. 
---
# YAML 元数据（用于静态网站生成器）
title: 张三 - 全栈工程师
layout: resume
...
# <u>张三</u> <small>(全栈工程师)</small>
📍 北京 | 📧 zhangsan@email.com | 💼 5年经验  
🔗 [GitHub](https://github.com/yourname) | [博客](https://blog.example.com)

---

## 🛠 技术栈
- **编程语言**: JavaScript (ES6+), Python, Go
...
## 💼 工作经历
### **高级开发工程师** @某科技公司 _(2020-至今)_
- 领导开发了公司核心产品后台系统，QPS提升300%
- 技术栈：Node.js + React + Kubernetes
- 成果：获得2022年公司技术创新奖

### **初级开发工程师** @创业公司 _(2018-2020)_
- 从0搭建用户管理系统
- 实现自动化测试覆盖率90%+
...
## 🏆 项目展示
### 1. [在线协作平台](https://demo.example.com)
![项目截图](/images/project1.png)  
- 技术栈：React + WebSocket + Go
- 功能：实时文档协作、版本控制
- 开源地址：[GitHub Repo](https://github.com/yourname/project)

```python
# 示例代码片段
def calculate_bonus(salary):
    return salary * 1.2 if salary > 10000 else salary
